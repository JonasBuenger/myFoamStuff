...
{
    #include "setRootCase.H"        // construct 'args' (argList)
    #include "createTime.H"         // construct 'runtime' (Time)
    #include "createMesh.H"         // construct 'mesh' (fvMesh)
    #include "createFields.H"       // construct Fields 's' 'Theta' ('nu' 'beta' 'corrDim')
