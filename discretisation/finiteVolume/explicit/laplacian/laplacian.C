...
void gaussLaplacian(volScalarField& vf, const scalar f, BlockLduMatrix<vectorType>& M, Field<vectorType>& B, const int dirI, const int dirJ){
...
template<class vectorType>
void gaussLaplacian(volVectorField& vf, const scalar f, BlockLduMatrix<vectorType>& M, Field<vectorType>& B, const int dirI, const int dirJ){
...
template<class vectorType>
void gaussLaplacian(volSymmTensorField& vf, const scalar f, BlockLduMatrix<vectorType>& M, Field<vectorType>& B, const int dirI, const int dirJ){
...
template<class vectorType>
void gaussLaplacian(volSymmTensorField& vf, BlockLduMatrix<vectorType>& M, Field<vectorType>& B, const int dirI, const int dirJ){

    gaussLaplacian(vf, M, B, 1, dirI, dirJ);

}

template<class vectorType>
void gaussLaplacian(volScalarField& vf, BlockLduMatrix<vectorType>& M, Field<vectorType>& B, const int dirI, const int dirJ){
...
template<class vectorType>
void gaussLaplacian(volVectorField& vf, BlockLduMatrix<vectorType>& M, Field<vectorType>& B, const int dirI, const int dirJ){
